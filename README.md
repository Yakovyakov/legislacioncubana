...
- Migración de descargas al directorio de caché
...
🔍 [Ver todas las versiones](https://github.com/yakovyakov/legislacioncubana/releases)

## 🚀 Características

### 🔍 Búsqueda Avanzada

- Filtros por **emisor**, **tipo de documento** y **tipo de gaceta**
- Búsqueda por **número de documento** específico
- Búsqueda por **año** de emisión
- Búsqueda de **texto** en el contenido

### 📄 Gestión de Documentos

- Visualización optimizada en tarjetas
- Acceso directo a documentos **PDF oficiales**
...
- **Modo claro/oscuro** con selector manual
- **Interfaz rediseñada** para mejor contraste
- **Navegación fluida** incluso en listas extensas
- **Teclado inteligente** que no oculta campos
...
- **Permisos de almacenamiento** para actualizaciones (Android < 10)
...
2. **Selecciona filtros** (emisor, tipo documento, etc.)
3. **Toca "Buscar"**
4. **Explora los resultados**

### Configuración del Tema

1. Ve a **Acerca de** (desde el menú principal)
2. Selecciona **Apariencia**
3. Elige entre **Claro**, **Oscuro** o **Seguir sistema**
4. Los cambios se aplican inmediatamente

### Uso de Cards Expandibles

1. **Toca cualquier card** de documento para expandir
2. **Ve detalles completos** sin salir de la lista
3. **Toca nuevamente** para colapsar
4. **Desliza horizontalmente** para ver más opciones

### Filtros Disponibles

| Filtro | Descripción |
|--------|-------------|
| **Emisor** | Organismo que emitió el documento |
| **Tipo Documento** | Ley, Decreto, Resolución, etc. |
| **Tipo Gaceta** | Ordinaria, Extraordinaria, Especial |
| **Número** | Número específico del documento |
| **Año** | Año de emisión (formato: YYYY) |
| **Contenido** | Texto dentro del documento |
...
3. **Actualización automática** después de verificación
4. **Notificación** en pantalla principal

### Proceso de Actualización

1. La app **verifica automáticamente** nuevas versiones al iniciar
2. Si hay actualización, muestra **notificación**
3. **Descarga** el APK en caché (sin permisos especiales)
4. **Verifica firma ECDSA** antes de instalar
5. **Instala automáticamente** manteniendo datos

### Actualización Manual

Si necesitas actualizar manualmente:

1. Ve a **Acerca de** en la aplicación
...
- **Comunicaciones HTTPS** en todas las conexiones
- **Sin almacenamiento** de datos personales

### Arquitectura de Seguridad

1. **Clave pública ECDSA** embebida en la app
2. **Servidor firma** `latest.json` con clave privada
3. **Verificación local** antes de cualquier actualización
4. **Protección contra** ataques MITM
...
📧 [yyak0423@gmail.com](mailto:yyak0423@gmail.com)  
✈️ [@Yak0v04](https://t.me/Yak0v04)

### Consultas Jurídicas

**Alejandro Fernández-Britto Wong**  
...
Sí, necesitas conexión a internet para realizar búsquedas y acceder a los documentos PDF.

### ¿Los documentos se descargan para uso offline?

No, la app funciona como cliente de consulta. Los documentos se acceden online.
...
- Verifica que tienes permitido instalar apps de fuentes desconocidas
- Asegúrate de tener suficiente espacio de almacenamiento
- Si usas Android < 10, otorga permisos de almacenamiento

### ¿Cómo sé si hay una nueva versión?

La app te notificará automáticamente. También puedes verificar manualmente en **Acerca de**.
...
📝 **Consulte el [CHANGELOG.md](./CHANGELOG.md) para detalles completos de todos los cambios.**

---

## ⭐ Apoya este Proyecto

**Si esta aplicación te resulta útil, considera apoyar su desarrollo de una de estas formas:**

- **Dale una estrella en GitHub.** Es la forma más sencilla de mostrar tu apoyo y ayudar a que más personas descubran el proyecto.
    [![Star this repo](https://img.shields.io/github/stars/yakovyakov/legislacioncubana?style=social&label=Dar%20una%20estrella)](https://github.com/yakovyakov/legislacioncubana/stargazers)
- **Sigue al desarrollador** para estar al tanto de futuras actualizaciones.
    [![Follow on GitHub](https://img.shields.io/github/followers/yakovyakov?label=Seguir%20%40yakovyakov&style=social)](https://github.com/yakovyakov)
- **Reporta errores o sugiere mejoras** abriendo un *Issue* en el repositorio.

¡Tu apoyo hace posible continuar el desarrollo y mejora de esta herramienta!
